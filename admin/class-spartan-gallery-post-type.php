 ...
 */
class SpartnaGalleryPostType {
    /**
     * @var string
     *
     * Set post type params
     */
    private $type               = 'spartan_gallery_type';
    private $slug               = 'spartan_gallery';
    private $name               = 'Spartan Gallerys';
    private $singular_name      = 'Spartan Gallery';
    /**
     * Register post type
     */
