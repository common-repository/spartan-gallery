				...
				if ( count( $images ) == 0 ) {
					...
					foreach ( $images as $image ) { ?>
                        <span class="exopite-sof-attachment-media exopite-sof-attachment-media-js"
                              data-media-id="<?php echo $image->ID; ?>">
															<a href="#" data-popup-open="popup-<?php echo $image->ID; ?>" ><span class="dashicons img-add-title dashicons-menu"></span></a>
															<span class="exopite-sof-attachment-media-delete-overlay"></span>
																		<span
